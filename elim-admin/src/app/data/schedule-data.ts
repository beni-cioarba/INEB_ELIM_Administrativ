...
export const SCHEDULE_DATA: ScheduleEntry[] = [
  ...
  { team: 'Echipa 4', coordinator: 'Miriam Mitoşeriu', programType: 'Seară de tineret', estimatedPersons: 60, date: new Date(2026, 4, 1), observations: '', completed: false },
  { team: 'Echipa 5', coordinator: 'Toader Noemi', programType: 'Seară de tineret', estimatedPersons: 60, date: new Date(2026, 4, 8), observations: '', completed: false },
  { team: 'Echipa 6', coordinator: 'Halas Noemi', programType: 'Seară de tineret', estimatedPersons: 60, date: new Date(2026, 4, 15), observations: '', completed: false },
  { team: 'Echipa 7', coordinator: 'Bereza Ionatan', programType: 'Seară de tineret', estimatedPersons: 60, date: new Date(2026, 4, 22), observations: '', completed: false },
  { team: 'Echipa 1', coordinator: 'Halas Luigi', programType: 'Seară de tineret', estimatedPersons: 60, date: new Date(2026, 4, 29), observations: '', completed: false },
  { team: 'Echipa 2', coordinator: 'Dobre David', programType: 'Seară de tineret', estimatedPersons: 60, date: new Date(2026, 5, 5), observations: '', completed: false },
];
